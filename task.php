...
<div class='parent flex-parent'>
    <div class='child flex-child'> 
        ...
        <input required id = "input_box" value="" placeholder = "Enter stock name" name="input_box">
    </div>
    <div class='child flex-child'>
        <label class="form-label" for="customFile">Start_Date:</label>
        <input required name = "datepicker" type="text" id="datepicker" value ="">
    </div>
    <div class='child flex-child'>
        <label class="form-label" for="customFile">End_Date:</label>
        <input required name = "datepicker2" type="text" id="datepicker2" value="">
    </div>
</div>
